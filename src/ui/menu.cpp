...
void Menu::showMainMenu() const
{
    ...
    std::cout << "20. Отримати перелік і загальне число локомотивів за часом прибуття на станції\n";

    std::cout << "21. Отримати перелік і загальне число локомотивів за кількістю скоєних рейсів\n";
    std::cout << "22. Отримати перелік і загальне число локомотивів які пройшли плановий техогляд за певний пераод часу\n";
    std::cout << "23. Отримати перелік і загальне число усіх локомотивів відправлених у ремонт в означений час\n";
    std::cout << "24. Отримати перелік і загальне число усіх локомотивів ремонтованих вказане число разів\n";
    std::cout << "25. Отримати перелік і загальне число усіх локомотивів за кількістю скоєних рейсів до ремонту\n";
    std::cout << "26. Отримати перелік і загальне число усіх локомотивів за віком локомотива\n";

    std::cout << "27. Отримати перелік і загальне число усіх поїздів на зазначеному маршруті\n";
    std::cout << "28. Отримати перелік і загальне число усіх поїздів по дистанції маршруту\n";
    std::cout << "29. Отримати перелік і загальне число усіх поїздів за ціною квитка\n";
    std::cout << "30. Отримати перелік і загальне число усіх поїздів на зазначеному маршруті, по дистанції маршруту та за ціною квитка\n";

    std::cout << "31. Отримати перелік і загальне число скасованих рейсів повністю\n";
    std::cout << "32. Отримати перелік і загальне число скасованих рейсів за вказаним маршрутом\n";
    std::cout << "33. Отримати перелік і загальне число скасованих рейсів за вказаним напрямком\n";
    std::cout << "34. Отримати перелік і загальне число затриманих рейсів\n";
    std::cout << "35. Отримати перелік і загальне число затриманих рейсів за причиною\n";
    std::cout << "36. Отримати перелік і загальне число затриманих рейсів за маршрутом\n";
    std::cout << "37. Отримати перелік і загальне число повернутих квитків за затриманими рейсами\n";

    std::cout << "38. Отримати перелік і середню кількість проданих квитків за вказаний інтервал часу на певні маршрути\n";
    std::cout << "39. Отримати перелік і середню кількість проданих квитків за вказаний інтервал часу за дистанцією маршруту\n";
    std::cout << "40. Отримати перелік і середню кількість проданих квитків за вказаний інтервал часу за ціною квитка\n";

    std::cout << "41. Отримати перелік і загальне число маршрутів зазначеної категорії\n";
    std::cout << "42. Отримати перелік і загальне число маршрутів зазначеної категорії в певному порядку\n";

    std::cout << "43. Отримати перелік і загальне число пасажирів на зазначеному рейсі\n";
    std::cout << "44. Отримати перелік і загальне число пасажирів які виїхали в зазначений день\n";
    std::cout << "45. Отримати перелік і загальне число пасажирів які виїхали за кордон у зазначений день\n";
    std::cout << "46. Отримати перелік і загальне число пасажирів за ознакою здачі речей в багажне відділення\n";
    std::cout << "47. Отримати перелік і загальне число пасажирів за статевою ознакою\n";
    std::cout << "48. Отримати перелік і загальне число пасажирів за віком\n";

    std::cout << "49. Отримати перелік і загальне число невикуплених квитків на зазначеному рейсі\n";
    std::cout << "50. Отримати перелік і загальне число невикуплених квитків на зазначеному маршруті\n";
    std::cout << "51. Отримати перелік і загальне число невикуплених квитків в зазначену дату\n";

    std::cout << "52. Отримати загальне число зданих квитків на вказаний рейс\n";
    std::cout << "53. Отримати загальне число зданих квитків на вказану дату\n";
    std::cout << "54. Отримати загальне число зданих квитків на вказаний маршрут\n";
...
void Menu::handleUserChoice() const
{
    ...
    case 20:
        getLocomotivesArrivalTimeAtStationCommand();
        break;
...
void Menu::getLocomotivesArrivalTimeAtStationCommand() const
{
    std::string id;
    std::cout << "Введіть ID станції: ";
    std::cin >> id;

    auto locomtives_arivval = services.getLocomotivesArrivalTimeAtStation(id);
    for (const auto &[locomotive, arrival] : locomtives_arivval)
    {
        std::cout << "Локомотив: " << locomotive->getId() << " час прибуття: " << arrival.serialize() << std::endl;
    }
    std::cout << "Кількість " << locomtives_arivval.size() << std::endl;
}
