...
std::string Cashier::serialize() const
{
...
std::shared_ptr<Cashier> Cashier::deserialize(const std::string &data)
{
    ...
    return std::make_shared<Cashier>(id, full_name, static_cast<SEX>(sex), Date::deserialize(birth), Date::deserialize(start_work), children_count, salary);
}
